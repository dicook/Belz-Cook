...
date: "[bit.ly/belz-cook](bit.ly/belz-cook)  <br><br>  <br><br>Oct 16, 2018"
output:
...
```{r fig.height=7}
library(sawfish)
fl <- find_files("https://www4.stat.ncsu.edu/~stefanski/nsf_supported/hidden_images/correct_model_files/", "txt")
...
- Expanding the computer model with simulations of all sorts of departures from no relationship
